...
class ImagemHistorico(models.Model):
    ...
    imagem = models.ImageField(blank=True, null=True, upload_to=id_imagem_historico)
    id_historico = models.ForeignKey(Historico, related_name='imagens', on_delete=models.CASCADE)